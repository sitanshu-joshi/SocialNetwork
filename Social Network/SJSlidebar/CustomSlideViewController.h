...
@protocol CustomSlideViewControllerDelegate;

#pragma mark - CustomSlideViewController Class
...
// Use this on iOS7 when you add an instance of RevealViewController as a child of a UINavigationController (or another CustomSlideViewController)
...
@property (readwrite, nonatomic) BOOL isFromFavorites;
@property (readwrite, nonatomic) BOOL isFromHome;
@property (readwrite, nonatomic) BOOL isFromInfoCard;
// Delegate
@property (weak, nonatomic) id<CustomSlideViewControllerDelegate> delegate;

@end

#pragma mark - CustomSlideViewControllerDelegate Protocol
...
- (void)revealController:(CustomSlideViewController *)revealController willMoveToPosition:(FrontViewPosition)position;
- (void)revealController:(CustomSlideViewController *)revealController didMoveToPosition:(FrontViewPosition)position;

// This will be called inside the reveal animation, thus you can use it to place your own code that will be animated in sync
- (void)revealController:(CustomSlideViewController *)revealController animateToPosition:(FrontViewPosition)position;

// Implement this to return NO when you want the pan gesture recognizer to be ignored
- (BOOL)revealControllerPanGestureShouldBegin:(CustomSlideViewController *)revealController;

// Implement this to return NO when you want the tap gesture recognizer to be ignored
- (BOOL)revealControllerTapGestureShouldBegin:(CustomSlideViewController *)revealController;

// Called when the gestureRecognizer began and ended
- (void)revealControllerPanGestureBegan:(CustomSlideViewController *)revealController;
- (void)revealControllerPanGestureEnded:(CustomSlideViewController *)revealController;
...
- (void)revealController:(CustomSlideViewController *)revealController panGestureBeganFromLocation:(CGFloat)location progress:(CGFloat)progress;
- (void)revealController:(CustomSlideViewController *)revealController panGestureMovedToLocation:(CGFloat)location progress:(CGFloat)progress;
- (void)revealController:(CustomSlideViewController *)revealController panGestureEndedToLocation:(CGFloat)location progress:(CGFloat)progress;

@end


#pragma mark - UIViewController(CustomSlideViewController) Category

// We add a category of UIViewController to let childViewControllers easily access their parent CustomSlideViewController
@interface UIViewController(CustomSlideViewController)

- (CustomSlideViewController*)revealViewController;

@end


// This will allow the class to be defined on a storyboard
#pragma mark - CustomSlideViewControllerSegue

@interface CustomSlideViewControllerSegue : UIStoryboardSegue

@property (strong) void(^performBlock)( CustomSlideViewControllerSegue* segue, UIViewController* svc, UIViewController* dvc );
